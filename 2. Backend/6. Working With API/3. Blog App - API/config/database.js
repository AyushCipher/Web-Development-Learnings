...
const connectWithDb = () => {
    mongoose.connect(process.env.DATABASE_URL, { // Calls the connect method of Mongoose to establish a connection to MongoDB, meaning database ko URL link k address pe connect kro
