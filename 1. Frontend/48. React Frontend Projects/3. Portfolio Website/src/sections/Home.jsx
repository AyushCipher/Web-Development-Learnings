...
const socials = [
  ...
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/ayush-verma-dev" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/verma_ji_ayush?igsh=a2diMWpydG9ocm12" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/AyushCipher" },
];
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              I transform complex ideas into seamless, high-impact web experiences, engineering modern, 
              scalable, and high-performance applications that deliver real-world impact.           
            </motion.p>
